// Slightly modified copy of default Fyne theme
// Original: https://github.com/fyne-io/fyne/blob/release/v1.4.x/theme/theme.go
...
var (
	...
	//	themeSecondaryColor = color.NRGBA{R: 0xff, G: 0x40, B: 0x81, App: 0xff}
)

// LightTheme defines the built in light theme colors and sizes
func HarboredTheme() fyne.Theme {
	theme := &builtinTheme{
...
func (t *builtinTheme) initFonts() {
	regularBytes := mewn.MustBytes("./fonts/rawline-400.ttf")
	boldBytes := mewn.MustBytes("./fonts/rawline-700.ttf")
	italicBytes := mewn.MustBytes("./fonts/rawline-400i.ttf")
	bolditalicBytes := mewn.MustBytes("./fonts/rawline-700i.ttf")
	monospaceBytes := mewn.MustBytes("./fonts/CourierPrime-Regular.ttf")
	regular = Font{
		name:    "Raleway-Regular.ttf",
		content: regularBytes,
	}
	bold = Font{
		name:    "Raleway-Bold.otf",
		content: boldBytes,
	}
	italic = Font{
		name:    "Raleway-RegularItalic.otf",
		content: italicBytes,
	}
	bolditalic = Font{
		name:    "Raleway-BoldItalic.otf",
		content: bolditalicBytes,
	}
	monospace = Font{
		name:    "CourierPrime-Regular.ttf",
		content: monospaceBytes,
	}
	t.regular = &regular
	t.bold = &bold
	t.italic = &italic
